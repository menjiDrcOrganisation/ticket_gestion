...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-md mt-8">
    ...
    >
        ...
        <!-- Nom -->
        <div>
            <label for="nom" class="block font-semibold text-gray-700 mb-1"
        ...
        <!-- Adresse -->
        <div>
            <label for="adresse" class="block font-semibold text-gray-700 mb-1"
                >Adresse</label
            >
            <input
                type="text"
        ...
        <!-- Salle -->
        <div>
            <label for="salle" class="block font-semibold text-gray-700 mb-1"
                >Salle</label
            >
            <input
                type="text"
    ...
    @foreach ($typeBillets as $ticket)
        <div>
            ...
            <div class="grid grid-cols-2 gap-2">
                <div>
                    <label for="quantite_{{ $ticket['id'] }}" class="block text-gray-500 text-sm mb-1">Quantité</label>
                    <input
                        type="number"
                        name="quantite[]"
                ...
                <div>
                    <label for="prix_{{ $ticket['id'] }}" class="block text-gray-500 text-sm mb-1">Prix(en Fc)</label>
                    <input
                        type="number"
                        name="prix[]"
                        id="prix_{{ $ticket['id'] }}"
