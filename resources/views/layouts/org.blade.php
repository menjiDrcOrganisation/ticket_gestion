...
<x-nav-element title="Info billets" action="{{ route('billet.all') }}">
</x-nav-element>

<x-nav-element title="Scanner" action="{{ route('scanneur.showScanner') }}">
</x-nav-element>

<x-nav-element title="Demande retrait" action="{{ route('retrait.index') }}">
</x-nav-element>
