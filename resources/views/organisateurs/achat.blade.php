    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="bg-white w-full p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="md:hidden space-y-4">
          ...
          @php
            $typeBillet = $achat->type_billet->first();
            $prixUnitaire = $typeBillet?->pivot->prix_unitaire ?? 0;
            $devise = $typeBillet?->pivot->devise ?? 'FC';
            $total = $prixUnitaire * $typeBillet?->pivot->quantite;
          @endphp
          <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 card-hover">
            ...
            <div class="mt-3">
              <p class="text-sm text-gray-700"><i class="fas fa-tag text-gray-400 mr-2"></i>{{ $typeBillet->nom_type ?? 'N/A' }} ({{ $achat->quantite }} billets)</p>
          ...
          <table class="min-w-full text-gray-700">
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              @php
                ...
                $quantite = $typeBillet?->pivot->quantite ?? 'FC';
